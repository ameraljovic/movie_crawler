...
public class ReaderLogger
{
    ...
    @Around ("execution(* ba.aljovic.amer.application.component.service.MovieRetriever.retrieveTitle(long)) && args(tmdbId)")
    ...
    @Around("execution(* ba.aljovic.amer.application.component.service.MovieRetriever.toUrl(String)) && args(title)")
